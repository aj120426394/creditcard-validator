...
(jQuery.easing.jswing = jQuery.easing.swing), jQuery.extend(jQuery.easing, {
            ...
            position: function() {
              ...
              var b = this[0],
                ...
                e = /^(?:body|html)$/i.test(a.nodeName)
                  ? { top: 0, left: 0 }
                  : c(a).offset();
              return (d.top -= parseFloat(b.style.marginTop) || 0), (d.left -=
                parseFloat(b.style.marginLeft) || 0), a.style &&
                (
          ...
          var u = (function() {
            ...
            return function d(a, b, e) {
              var f,
                ...
                m = 0.016;
              for (
                a = parseFloat(a) || 500, b = parseFloat(b) || 20, e =
                  e || null, i.tension = a, i.friction = b, f = null !== e, f
                  ? ((k = d(a, b)), (g = k / e * m))
                  : (g = m);
                (h = c(h || i, g)), j.push(1 + h.x), (k += 16), Math.abs(h.x) >
                  l && Math.abs(h.v) > l;
          ...
          var v = (t.CSS = {
            ...
            getPropertyValue: function(a, c, e, f) {
              ...
              if (v.Hooks.registered[c]) {
                var j = c,
                  k = v.Hooks.getRoot(j);
                e === d &&
                  (e = v.getPropertyValue(a, v.Names.prefixCheck(k)[0])), v
                  .Normalizations.registered[k] &&
                ...
                var l, o;
                (l = v.Normalizations.registered[c]('name', a)), 'transform' !==
                  l &&
                  (
            ...
            setPropertyValue: function(a, c, d, e, f) {
              ...
              if ('scroll' === c)
                ...
                v.Normalizations.registered[c]('inject', a, d), (h =
                  'transform'), (d = g(a).transformCache[c]);
              else {
                if (v.Hooks.registered[c]) {
                  var i = c,
                    j = v.Hooks.getRoot(c);
              ...
              function a(a) {
                function l(a, b) {
                  ...
                  return p.isArray(a)
                    ...
                    (c = c.call(f, y, x)), p.isFunction(g) &&
                    (g = g.call(f, y, x)), [c || 0, e, g];
                }
                function n(a, b) {
                  var c, d;
                  return (d = (b || '0')
                ...
                function r() {
                  ...
                  (I.lastParent = a.myParent), (I.lastPosition =
                    a.position), (I.lastFontSize = a.fontSize);
                  var h = 100,
                    i = {};
                  if (e && d)
                    (i.emToPx = I.lastEmToPx), (i.percentToPxWidth =
                      I.lastPercentToPxWidth), (i.percentToPxHeight =
                  ...
                  return null === I.remToPx &&
                    ...
                    ), (i.remToPx = I.remToPx), (i.vwToPx =
                    I.vwToPx), (i.vhToPx = I.vhToPx), t.debug >= 1 &&
                ...
                if ('scroll' === C) {
                  ...
                  'none' === g(f).opts.display &&
                    (g(f).opts.display = 'auto'), 'hidden' ===
                    g(f).opts.visibility &&
                    (g(f).opts.visibility = 'visible'), (g(
                    f
                  ).opts.loop = !1), (g(f).opts.begin = null), (g(
                    f
                  ).opts.complete = null), s.easing ||
                    delete h.easing, s.duration ||
                    delete h.duration, (h = m.extend({}, g(f).opts, h));
              ...
              t.mock !== !1 &&
                (t.mock === !0
                  ...
                  : (
                    ...
                    )), (h.easing = j(h.easing, h.duration)), h.begin &&
                  ...
                  if (!m.isPlainObject(q) || p.isEmptyObject(q)) {
                    if (p.isString(q) && t.Redirects[q]) {
                      ...
                      return E.backwards === !0 &&
                        (o = m.extend(!0, [], o).reverse()), m.each(o, function(
                        a,
                        b
                      ) {
                        parseFloat(E.stagger)
                          ...
                          : p.isFunction(E.stagger) &&
                            (E.delay = G + E.stagger.call(b, a, x)), E.drag &&
                          (
                            (E.duration =
                              parseFloat(F) ||
            ...
            function(a, b) {
              t.Redirects['slide' + b] = function(a, c, e, f, g, h) {
                ...
                i.display === d &&
                  ...
                  (n.overflow = a.style.overflow), (a.style.overflow =
                    'hidden');
                }), (i.complete = function() {
  ...
  function fa(a, b) {
    (b = b || {}), (this.options = i(
      ...
      this
    )), (this.touchAction = new T(this, this.options.touchAction)), ga(
      this,
      !0
    ), g(
      b.recognizers,
...
(Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity), (function(a) {
  (a.fn.collapsible = function(b) {
    ...
    return (b = a.extend(c, b)), this.each(function() {
      function c(b) {
        ...
        )), b.hasClass('active') ? b.parent().addClass('active') : b.parent().removeClass('active'), b
          .parent()
          .hasClass('active')
          ? b.siblings('.collapsible-body').stop(!0, !1).slideDown({
              duration: 350,
              easing: 'easeOutQuart',
              queue: !1,
              complete: function() {
      ...
      function d(b) {
        b.hasClass('active')
          ...
          : b.parent().removeClass('active'), b.parent().hasClass('active')
          ? b.siblings('.collapsible-body').stop(!0, !1).slideDown({
              duration: 350,
              easing: 'easeOutQuart',
              queue: !1,
        ...
        : void this.each(function() {
            function b() {
              void 0 !== f.data('induration') &&
                (g.inDuration = f.data(
                  'induration'
                )), void 0 !== f.data('outduration') && (g.outDuration = f.data('outduration')), void 0 !== f.data('constrainwidth') && (g.constrain_width = f.data('constrainwidth')), void 0 !== f.data('hover') && (g.hover = f.data('hover')), void 0 !== f.data('gutter') && (g.gutter = f.data('gutter')), void 0 !== f.data('beloworigin') && (g.belowOrigin = f.data('beloworigin')), void 0 !== f.data('alignment') && (g.alignment = f.data('alignment')), void 0 !== f.data('stoppropagation') && (g.stopPropagation = f.data('stoppropagation'));
            }
            function d(c) {
              'focus' === c &&
                (h = !0), b(), i.addClass('active'), f.addClass('active'), g.constrain_width === !0 ? i.css('width', f.outerWidth()) : i.css('white-space', 'nowrap');
              ...
              i.css({
                ...
                .animate(
                  { opacity: 1 },
                  { queue: !1, duration: g.inDuration, easing: 'easeOutSine' }
                );
            }
            function e() {
            ...
            if ((b(), f.after(i), g.hover)) {
              var j = !1;
              f.unbind('click.' + f.attr('id')), f.on('mouseenter', function(
                a
              ) {
                j === !1 && (d(), (j = !0));
              ...
              f.unbind('click.' + f.attr('id')), f.bind(
                'click.' + f.attr('id'),
                function(b) {
                  h ||
                    (
  ...
  a.fn.extend({
    openModal: function(c) {
      ...
      if (!h.hasClass('open')) {
        ...
        (lStack = ++b), j
          .attr('id', i)
          .css('z-index', 1e3 + 2 * lStack), h
          .data('overlay-id', i)
          .css('z-index', 1e3 + 2 * lStack + 1), h.addClass('open'), a(
          'body'
        ).append(j), (c = a.extend(g, c)), c.dismissible &&
          (
            j.click(function() {
              h.closeModal(c);
            }),
        ...
        ), h.data('associated-overlay', j[0]), h.hasClass('bottom-sheet')
          ? h.velocity(
              { bottom: '0', opacity: 1 },
              {
    ...
    closeModal: function(c) {
      ...
      e.removeClass('open'), (c = a.extend(d, c)), a('body').css({
        overflow: '',
        width: ''
      }), e.find('.modal-close').off('click.close'), a(document).off(
        'keyup.leanModal' + f
      ), g.velocity(
        { opacity: 0 },
          ...
          { opacity: 0 },
          {
            ...
            complete: function() {
              b.css({
                ...
                position: '',
                'z-index': ''
              }), i.removeClass('active'), (f = !0), a(this).remove(), c &&
                c.css('overflow', '');
            }
          }
        );
    ...
    init: function(b) {
      ...
      return (b = a.extend(c, b)), this.each(function() {
        ...
        var d,
          ...
          i = 0;
        (d = a(
          f.filter('[href="' + location.hash + '"]')
        )), 0 === d.length && (d = a(this).find('li.tab a.active').first()), 0 === d.length && (d = a(this).find('li.tab a').first()), d.addClass('active'), (i = f.index(d)), 0 > i && (i = 0), void 0 !== d[0] && (e = a(d[0].hash)), c.append('<div class="indicator"></div>');
        var j = c.find('.indicator');
        c.is(':visible') &&
          (j.css({ right: g - (i + 1) * h }), j.css({ left: i * h })), a(
          window
        ).resize(function() {
          ...
          if (!a(this).attr('target')) {
            (g = c.width()), (h =
              Math.max(g, c[0].scrollWidth) / f.length), d.removeClass(
              'active'
            ), void 0 !== e && e.hide(), (d = a(this)), (e = a(
              this.hash
            )), (f = c.find('li.tab a')), d.addClass('active');
            var l = i;
            (i = f.index(a(this))), 0 > i && (i = 0), void 0 !== e &&
              (
                e.show(),
  ...
  a.fn.tooltip = function(c) {
    ...
    return 'remove' === c
      ? (
          this.each(function() {
            a(
              '#' + a(this).attr('data-tooltip-id')
            ).remove(), a(this).off('mouseenter.tooltip mouseleave.tooltip');
          }),
          !1
        )
      : (
            ...
            var g,
              ...
              m = function() {
                (g = f.attr('data-html')
                  ...
                  : c.html), (h = f.attr('data-delay')), (h =
                  void 0 === h || '' === h ? c.delay : h), (i = f.attr(
                  'data-position'
                )), (i =
                  void 0 === i || '' === i ? c.position : i), (j = f.attr(
                  'data-tooltip'
                    ...
                    : 'left' === i
                      ...
                      : 'right' === i
                        ...
                        : (
                          ...
                          ), k.css({ top: e.y, left: e.x }), (r =
                    Math.SQRT2 * n / parseInt(l.css('width'))), (s =
                    Math.SQRT2 * j / parseInt(l.css('height'))), k
                    .velocity(
    ...
    j = {
      ...
      show: function(a, b) {
        ...
        'touches' in a &&
          ...
          ), f.setAttribute('data-hold', Date.now()), f.setAttribute(
          'data-scale',
          k
        ...
        (f.className = f.className + ' waves-notransition'), f.setAttribute(
          ...
          j.duration + 'ms'), (l['-moz-transition-duration'] =
          j.duration + 'ms'), (l['-o-transition-duration'] =
          j.duration + 'ms'), (l['transition-duration'] =
          j.duration + 'ms'), (l['-webkit-transition-timing-function'] =
        ...
        for (var b = 0; b < a.length; b++) {
          ...
          if ('input' === c.tagName.toLowerCase()) {
            ...
            f || (f = ''), e.setAttribute('style', f), (c.className =
              'waves-button-input'), c.removeAttribute('style'), d.replaceChild(
              e,
              c
            ), e.appendChild(c);
          }
    ...
    i = setInterval(function() {
      null === g.parentNode &&
        window.clearInterval(
          i
        ), g.classList.contains('panning') || (h -= 20), 0 >= h &&
        (
          Vel(
            g,
  ...
  var b = {
    init: function(b) {
      ...
      (b = a.extend(c, b)), a(this).each(function() {
        function c(c) {
          (g = !1), (h = !1), a('body').css({ overflow: '', width: '' }), a(
            '#sidenav-overlay'
          ).velocity(
            { opacity: 0 },
            {
        ...
        a('body').append(
          f
        ), 'left' == b.edge ? (e.css('transform', 'translateX(-100%)'), f.css({ left: 0 })) : (e.addClass('right-aligned').css('transform', 'translateX(100%)'), f.css({ right: 0 })), e.hasClass('fixed') && window.innerWidth > 992 && e.css('transform', 'translateX(0)'), e.hasClass(
          'fixed'
        ) &&
          a(window).resize(function() {
        ...
        f.on('click', function() {
          ...
          .bind('pan', function(d) {
            if ('touch' == d.gesture.pointerType) {
              ...
              if (
                (
                  'left' === b.edge &&
                    (f > b.menuWidth ? (f = b.menuWidth) : 0 > f && (f = 0)),
                  'left' === b.edge
                )
              )
                f < b.menuWidth / 2
          ...
          .bind('panend', function(c) {
            if ('touch' == c.gesture.pointerType) {
              var d = c.gesture.velocityX,
                ...
                j = i - b.menuWidth,
                k = i - b.menuWidth / 2;
              j > 0 && (j = 0), 0 > k && (k = 0), (g = !1), 'left' === b.edge
                ? (h && 0.3 >= d) || -0.5 > d
                  ? (
                      0 !== j &&
                        e.velocity(
          ...
          if (h === !0) (h = !1), (g = !1), c();
            ...
            var d = a('body'),
              i = d.innerWidth();
            d.css('overflow', 'hidden'), d.width(i), a('body').append(
              f
            ), 'left' === b.edge
              ? (
                  f.css({ width: '50%', right: 0, left: '' }),
  ...
  (a.scrollSpy = function(b, d) {
    ...
    }), (k.top = d.offsetTop || 0), (k.right = d.offsetRight || 0), (k.bottom =
      d.offsetBottom || 0), (k.left = d.offsetLeft || 0);
    var l = e(c, d.throttle || 100),
      m = function() {
        a(document).ready(l);
      };
    return i || (f.on('scroll', m), f.on('resize', m), (i = !0)), setTimeout(
      m,
      0
  ...
  a(document).ready(function() {
    function b(b) {
      ...
      d &&
        e.css(
          'font-size',
          d
        ), c && e.css('font-family', c), f && e.css('line-height', f), 'off' === b.attr('wrap') && e.css('overflow-wrap', 'normal').css('white-space', 'pre'), e.text(b.val() + '\n');
      var g = e.html().replace(/\n/g, '<br>');
      e.html(
        g
      ), b.is(':visible') ? e.css('width', b.width()) : e.css('width', a(window).width() / 2), b.css('height', e.height());
    }
    ...
    a(document).on('change', c, function() {
      ...
      0 === b.val().length &&
        ...
        (c +=
          ', label'), b.siblings(c).removeClass('active'), validate_field(b);
    ...
    a(document).on('change', h, function(b) {
      ...
      c.length <= 0 &&
        (
          ...
          a(this).after(c)
        ), c.find('.value').html(a(this).val()), (i = !0), a(this).addClass('active'), c.hasClass('active') || c.velocity({ height: '30px', width: '30px', top: '-20px', marginLeft: '-15px' }, { duration: 300, easing: 'easeOutExpo' }), 'input' !== b.type && ((g = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left), 0 > g ? (g = 0) : g > d && (g = d), c.addClass('active').css('left', g)), c.find('.value').html(a(this).val());
      ...
      if (i) {
        ...
        0 > c ? (c = 0) : c > e && (c = e), d
          .addClass('active')
          .css('left', c), d.find('.value').html(d.siblings(h).val());
      }
              ...
              for (var h in d)
                if (
                  ...
                  d[h]
                    ...
                    : i.append('<span>' + h + '</span>'), f.append(i), g(e, i);
                }
    ...
    a(this).each(function() {
      ...
      if (!d.hasClass('browser-default')) {
        ...
        d.before(q), q.before(o), q.after(i), d.is(':disabled') ||
          q.dropdown({ hover: !1, closeOnClick: !1 }), d.attr('tabindex') &&
    ...
    init: function(b) {
      ...
      return (b = a.extend(c, b)), this.each(function() {
        ...
        function d(a) {
          a >= j.length
            ? (a = 0)
            : 0 > a && (a = j.length - 1), (k = i.find('.active').index()), k !=
            a &&
            (
              (e = j.eq(k)),
        ...
        -1 != k &&
          (e = j.eq(
            k
          )), h.hasClass('fullscreen') || (b.indicators ? h.height(b.height + 40) : h.height(b.height), i.height(b.height)), j.find('.caption').each(function() {
          c(a(this), 0);
          ...
          ), e ? e.show() : (j.first().addClass('active').velocity({ opacity: 1 }, { duration: b.transition, queue: !1, easing: 'easeOutQuad' }), (k = 0), (e = j.eq(k)), b.indicators && f.eq(k).addClass('active')), e.find('img').each(function() {
          e
            .find('.caption')
            .velocity(
              { opacity: 1, translateX: 0, translateY: 0 },
        ...
        : (
              ...
              e.$el.each(function() {
                ...
                if (!c.data('initialized')) {
                  ...
                  (!d.data || !d.data instanceof Array) &&
                    (d.data = []), c.data('chips', d.data), c.data(
                    'index',
                    b
                  ), c.data('initialized', !0), c.hasClass(e.SELS.CHIPS) ||
                    c.addClass('chips'), e.chips(c), b++;
                }
              });
            }),
            (this.handleEvents = function() {
              ...
              e.$document.on('click', b.CHIPS, function(c) {
                  ...
                  if (f.length)
                    if (8 === c.which || 46 === c.which) {
                      ...
                      h > d + 1
                        ? (j = d)
                        : (d === h || d + 1 === h) && (j = h - 1), 0 > j &&
                        (j = null), null !== j && e.selectChip(i, j, g), h ||
                        g.find('input').focus();
                    } else if (37 === c.which) {
                      if (((d = f.index() - 1), 0 > d)) return;
                      a(b.CHIP).removeClass('selected'), e.selectChip(
                        g.data('index'),
                        d,
                        g
                      );
                ...
                a(c.target).closest(b.CHIPS).addClass('focus'), a(
                  b.CHIP
            ...
            (this.chips = function(a) {
              ...
              a.data('chips').forEach(function(a) {
                b += e.renderChip(a);
              }), (b += '<input class="input" placeholder="">'), a.html(
                b
              ), e.setPlaceholder(a);
            }),
            (this.renderChip = function(a) {
              if (a.tag) {
                ...
                return a.image && (b += ' <img src="' + a.image + '"> '), (b +=
                  '<i class="material-icons close">close</i>'), (b += '</div>');
              }
            }),
            ...
            (this.addChip = function(b, c, d) {
              if (e.isValid(d, c)) {
                ...
                d.data('chips').push(c), a(f).insertBefore(
                  d.find('input')
                ), d.trigger('chip.add', c), e.setPlaceholder(d);
              }
            }),
            (this.deleteChip = function(a, b, c) {
              var d = c.data('chips')[b];
              c.find('.chip').eq(b).remove(), c
                .data('chips')
                .splice(b, 1), c.trigger('chip.delete', d), e.setPlaceholder(c);
            }),
      ...
      : (
          ...
          this.each(function() {
            ...
            var e = Materialize.guid(),
              f = a(this),
              g = a(this).offset().top;
            a(this).data('pushpin-id', e), d(f, a(window).scrollTop()), a(
              window
  ...
  var b = function(b) {
    ...
    c = function(a) {
      ...
      $this.find('ul .btn-floating').velocity('stop', !0), $this
        .find('ul .btn-floating')
        .velocity(
          {
            opacity: '0',
  ...
  (Materialize.fadeInImage = function(b) {
    ...
    var d = 0;
    c.find('li').velocity({ translateX: '-100px' }, { duration: 0 }), c
      .find('li')
      .each(function() {
        a(this).velocity(
      ...
      y = (x.prototype = {
        ...
        on: function(b, c, d) {
          ...
          if (b) {
            g || (h[b] = c);
            for (e in h)
              (f = h[e]), d && (e = '_' + e), (t.methods[e] =
                t.methods[e] || []), t.methods[e].push(f);
          }
          return y;
        },
        off: function() {
    ...
    var b = this,
      ...
      q = function(d) {
        ...
        void 0 == d
          ...
          : 'short_months' == d
            ? null != i ? f.node('div', e[i.month]) : f.node('div', e[k.month])
      ...
      return (b = a.extend(c, b)), this.each(function() {
        function c() {
          'undefined' != typeof window.ontouchstart &&
            ...
            ), H[0].addEventListener('mousedown', l), H[0].addEventListener('mousemove', m), H[0].addEventListener('mouseup', n), H[0].addEventListener('mouseleave', n), H[0].addEventListener('click', j);
        }
        function d(a) {
        ...
        function k(a) {
          ...
          b.no_wrap ||
            (0 > c
              ...
              : c > 0 &&
                Math.abs(c - t) < c &&
                (c -= t)), 0 > c ? H.trigger('carouselNext', [Math.abs(c)]) : c > 0 && H.trigger('carouselPrev', [c]);
        }
        function l(a) {
        ...
        if (b.full_width) {
          ...
          J.length
            ...
            H.find('.carousel-fixed-item').addClass('with-indicators');
        }
        H.addClass(
          'initialized'
        ), (r = !1), (p = x = 0), (o = []), (item_width = H.find('.carousel-item').first().innerWidth()), (s = 2 * item_width + b.padding), H.find(
          '.carousel-item'
        ).each(function(b) {
        ...
        }), I && H.append(G), (t = o.length), (A = 'transform'), [
          'webkit',
          'Moz',
          'O',
          'ms'
          ...
          return 'undefined' != typeof document.body.style[b]
            ? ((A = b), !1)
            : !0;
        }), (window.onresize = g), c(), g(p), a(
          this
        ).on('carouselNext', function(a, b) {
          void 0 === b &&
            (b = 1), (x = p + s * b), p !== x && ((w = x - p), (C = Date.now()), requestAnimationFrame(i));
